...
let DESCRIPTION = {
    ...
    construction: ["To build houses for your city, you need plancks and stones. Stones are collected by a quarry. A sawmill produces plancks from wood. To get started collecting plancks and stones, build a woodcutter hut, a quarry, and a sawmill",

                   "Be careful to not run out of wood! Build a forester hut to get a forester to plant new trees."],

    lookingForResources: ["To create tools and weapons you need an industry, and to have an industry you need resources. Resources are things like minerals to mine, forest for getting wood, water for fishing, and grass planes for farming.",

                          "You should start by using the resources available in your city but soon you'll need to expand your land to discover new resources. To do so, build military buildings close to the border to expand it. Military buildings are Barracks, Guard House, Watch Tower, and Fortress.",
    ...
    food: ["Food is needed to support the miners. There are three types of food: meat, bread, and fish.",
           ...
           "Meat can be produced in two ways. A hunter in a hunter hut can hunt for wild animals, and a pig farm can breed pigs that are then sent to the slaughter house to produce meat.",
    ...
    military: ["To recruit new military you need equipment. The armory produces swords and shields but it needs coal and steel to do so. Coal comes from coal mines and steel comes from the Iron Smelter. The Iron Smelter needs iron and coal to melt the iron.",
    ...
    ranksAndPromotion: ["Militaries can have different ranks: private, private first class, sergeant, officer, general. All militaries start out as privates and can then be promoted to higher classes. A higher rank means that the military can survive more fights and cause more damage to opponents. Militaries in a building are promoted when a coin is delivered to the building.",
