...
const HELP_PAGES: PageType[] = [
    {
        ...
        pictures: ['ForesterHut', 'Woodcutter', 'Sawmill'].map(house => isBuilding(house) && <HouseIcon houseType={house} nation='ROMANS' key={house}/>),
...

    {
        page: 'mining',
        title: 'Mining',
        pictures: ['GoldMine'].map(house => isBuilding(house) && <HouseIcon houseType={house} nation='ROMANS' key={house}/>),
...

    {
        ...
        pictures: ['HunterHut', 'Fishery', 'Well', 'Mill', 'Farm', 'Bakery', 'PigFarm', 'SlaughterHouse'].map(house => isBuilding(house) && <HouseIcon houseType={house} nation = 'ROMANS' key={house}/>),
...

    {
        page: 'military',
        title: 'Recruiting',
        pictures: ['Brewery', 'Armory'].map(house => isBuilding(house) && <HouseIcon houseType={house} nation='ROMANS' key={house}/>),
...

    {
        page: 'war',
        title: 'Going to war',
        pictures: ['Barracks', 'GuardHouse', 'WatchTower', 'Fortress'].map(house => isBuilding(house) && <HouseIcon houseType={house} nation='ROMANS' key={house}/>),
